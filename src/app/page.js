  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center pt-4">
        <Image src="/home.jpg" alt="NextEcomm" width={800} height={500}></Image>
      </div>
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">NextEcomm</h1>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">A marketplace for people who wantsb to look good.</p>
          </div>
